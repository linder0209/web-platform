		    ...
		    setInfoWindow : function() {
                ...
                for(var key in markers){
		            google.maps.event.addListener(markers[key], 'click',
		                    function() {
		                        var currentMarkerIp = this.getTitle();
		
								var tempData = $.tmpl('bubbleMarker',{
									markerId : key
								});
								// add click event
								me.addEditEvent(tempData);
								
		                        me.infoWindow.setContent($(tempData)[0]);
		                        me.infoWindow.open(me.customMap, this);
								
								
		                        setTimeout(function() {
		                                    $('.infowindow_hidden_scrollbar').parent()
...
//                            }
		    ...
		    editByDrag : function(markerId) {
		    	var me = this, 
                	marker = this.findMarker(markerId);
                if(marker){
                	...
                	google.maps.event.addListener(marker,
                            'dragend', function() {
                                ...
                                me.codeLatLng(latlng, this, markerId);
                            });
                }
            },
		    ...
		    codeLatLng : function(latlng, currentMarker, markerId) {
                var me = this;
                this.geocoder.geocode({
                            'latLng' : latlng,
                            'language' : this.geocodingLanguage.en
		    ...
		    findMarker : function(markerId){
		    	return this.markersArray[markerId];
		    },
