...
(function($) {
	...
	$.extend($.validator, {
		...
		defaults : {
			...
			// custom add wangyanjun
			/* tip显示类型，有以下几种
				title：html原生的提示信息
				float
			*/
			tipType : 'title',
			tipPosition : 'right',//当tipType取title时，该参数无效
			tipAanimation : false
		},
		...
		prototype : {
			...
			showErrors : function(errors) {
				...
				// 如果自定义了showErrors，则调用该函数，否则调用默认的defaultShowErrors函数
			...
			**/
			...
			//把验证信息加入到this.errorList，this.errorMap和this.submitted中
